...
var newDate=new Date(Date.UTC(date.getFullYear(),(date.getMonth()+i_num)));tswitch[i_num].innerHTML=newDate.getFullYear()+' '+settings.titleMonths[newDate.getMonth()];var dataDays=[];var dataUTCDate=[];var days=[];var nextDate=Date.UTC(date.getFullYear(),(date.getMonth()+i_num));var date=new Date(nextDate)
